...
class Classifier3D(nn.Module):
    ...
    def __init__(self, n_class):
        ...
        self.fc1 =  nn.Linear(512*3*4*3, n_class)
...
class AutoEncoder3D(nn.Module):
    ...
    def __init__(self):
        ...
        self.deconv4 = nn.ConvTranspose3d(512, 256,kernel_size=(4,3,4), padding=1, stride=2)
        self.deconv3 = nn.ConvTranspose3d(256, 128,kernel_size=4, padding=1, stride=2)
        self.deconv2 = nn.ConvTranspose3d(128, 64,kernel_size=4, padding=1, stride=2)
        self.deconv1 = nn.ConvTranspose3d(64, 1,kernel_size=4, padding=1, stride=2)
